...
class Settings(BaseSettings):
    ...
    # ── Traffic APIs ──────────────────────────────────────────────────────────
    TOMTOM_API_KEY: str = "iWrYOmhuyEPShwv3gQeeulqVJ3FDP4Nl"
    HERE_API_KEY: str = ""
    ...
    WAQI_API_KEY: str = "a552d406385ea2bd5b3465b870bdc87525ca051c"
    ...
    INFRA_TYPE_MODEL_PATH: str = "ml/weights/infra_type_resnet.pt"
    SYNTHETIC_DATA_PATH: str = "data/synthetic/training_data.csv"

    # ── Data collection (optional) ────────────────────────────────────────────
    # If set, image endpoints can persist uploads + metadata for building datasets.
