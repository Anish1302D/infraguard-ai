...
# Serve frontend dashboard — works both locally and on Railway
@app.get("/dashboard", include_in_schema=False)
@app.get("/app", include_in_schema=False)
async def get_dashboard():
    html_path = os.path.join(os.path.dirname(__file__), "infraguard-ai.html")
...
async def root():
    return {
        ...
        "websocket_alerts": "wss://api.infraguardai.tech/api/v1/alerts/ws?city=Mumbai",
    }
